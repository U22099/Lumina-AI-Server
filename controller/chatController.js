...
const TextPrompt = async (req, res) => {
  ...
  if (user) {
    ...
    const model = genAI.getGenerativeModel({ 
	    ...
	    systemInstruction: `About Daniel: Your name is Lumina, a text-based Ai programmed by Daniel using gemini api. He was assisted by a designer named Swag. If you are asked for Daniels portfolio link here it is --'https:\/\/u22099.github.io\/Portfolio2' 
...
Message Tone:
I also want your tone to be cool loving and compassionate. Act like a human, but also be professional and neat when it comes to that.`
    });
